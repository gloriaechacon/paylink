      ...
      <div className="max-w-2xl w-full text-center space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-xl">
            Generá un link. Tu cliente paga con lo que tenga.<br />
            Vos recibís USDC en Solana.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/dashboard" className="bg-green-400 text-black font-bold px-8 py-4 rounded-xl text-lg hover:bg-green-300 transition-colors">
            Crear mi link de pago
          </a>
          <a href="/pay/demo" className="border border-gray-700 text-white font-bold px-8 py-4 rounded-xl text-lg hover:border-gray-500 transition-colors">
            Ver demo
          </a>
        </div>
